SELECT TOP(10) COUNT(a.orderId) as [Number of orders], a.component, a.comp_name, a.basicUom, SUM(a.[Lost/gained]) as [Lost/Gained], SUM(a.[Lost/gained value]) as [Lost/gained value], a.[Produced in month]
FROM (
	...
	WHERE comp.zfinType='zpkg' AND pc.actualConsumption > 0
) a
GROUP BY a.component, a.comp_name, a.basicUom, a.[Produced in month]
HAVING a.[Produced in month]='2018_4'